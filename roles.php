...
// Fetch users
$users = [];
$stmt = $conn->prepare("SELECT id, nom, prenom, email, role FROM accounts ORDER BY id ASC");
$stmt->execute();
...
<head>
    ...
    <title>Gestion des Utilisateurs - Université XYZ</title>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="container">
                ...
                <div class="controls">
                    <input type="text" id="searchBar" class="search-bar" placeholder="Rechercher un utilisateur...">
                </div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody id="userTable">
                        <?php foreach ($users as $user): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($user['nom'] ?: 'Non renseigné'); ?></td>
                                <td><?php echo htmlspecialchars($user['prenom'] ?: 'Non renseigné'); ?></td>
                                <td><?php echo htmlspecialchars($user['email']); ?></td>
                                <td><?php echo htmlspecialchars($user['role']); ?></td>
                                <td>
                                    <a href="modifier_role.php?id=<?php echo $user['id']; ?>" 
