...
// Fetch students
$students = [];
$stmt = $conn->prepare("SELECT id, nom, prenom, classe, numero_telephone, adresse FROM accounts WHERE role = 'etudiant' ORDER BY id ASC");
$stmt->execute();
...
<head>
    ...
    <title>Gestion des Étudiants - Université XYZ</title>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="container">
                ...
                <div class="controls">
                    <a href="ajouter_étudiant.php" class="btn"><i class="bi bi-plus"></i> Ajouter un étudiant</a>
                    <input type="text" id="searchBar" class="search-bar" placeholder="Rechercher un étudiant...">
                </div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody id="studentTable">
                        <?php foreach ($students as $student): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($student['numero_telephone'] ?: 'Non renseigné'); ?></td>
                                <td><?php echo htmlspecialchars($student['adresse'] ?: 'Non renseignée'); ?></td>
                                <td>
                                    <a href="details_étudiant.php?id=<?php echo $student['id']; ?>" 
                                       class="action-btn view"><i class="bi bi-eye"></i></a>
                                    <a href="modifier_étudiant.php?id=<?php echo $student['id']; ?>" 
                ...
                <?php if (empty($students)): ?>
                    <p class="no-results">Aucun étudiant trouvé.</p>
                <?php endif; ?>
            </div>
        ...
        document.getElementById('searchBar').addEventListener('input', function(e) {
            ...
            rows.forEach(row => {
                ...
                if (nom.includes(searchTerm) || prenom.includes(searchTerm) || 
                    classe.includes(searchTerm) || telephone.includes(searchTerm) || 
